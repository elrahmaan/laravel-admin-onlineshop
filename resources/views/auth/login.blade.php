        ...
        <div class="container-fluid h-100">
            <div class="row flex-row h-100 bg-white">
                <div class="col-xl-8 col-lg-6 col-md-5 p-0 d-md-block d-lg-block d-sm-none d-none">
                    <div class="lavalite-bg" style="background-image: url('/style/img/auth/login-bg.jpg')">
                    ...
                    <div class="authentication-form mx-auto">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Email" required="" value="{{ old('email') }}" required autocomplete="email" autofocus>
